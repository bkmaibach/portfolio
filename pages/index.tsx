...
export default function Home({
  ...
  return (
    <Layout>
      <Banner />
      <Spotlight
        edgeStyle={spotlightStyles.bottom}
        accentStyle={spotlightStyles.accent1}
        id="one"
        nextId="two"
        imgSrc="/images/pic02.webp"
      >
      ...
      <Spotlight
        edgeStyle={spotlightStyles.right}
        accentStyle={spotlightStyles.accent3}
        id="two"
        nextId="three"
        imgSrc="/images/pic03.webp"
      >
        <header>
      ...
      <Spotlight
        edgeStyle={spotlightStyles.left}
        accentStyle={spotlightStyles.accent4}
        id="three"
        nextId="four"
        imgSrc="/images/pic04.webp"
      >
        <header>
          <h2>Interdum amet non magna accumsan</h2>
          <p>Nunc commodo accumsan eget id nisi eu col volutpat magna</p>
        ...
        <p>
          AAA Feugiat accumsan lorem eu ac lorem amet ac arcu phasellus tortor
      ...
      <Wrapper
        style={wrapperStyles.style1}
        fadeStyle={wrapperStyles.fadeDown}
        id="four"
      >
      ...
      <Wrapper
        id="five"
        style={wrapperStyles.style2}
        fadeStyle={wrapperStyles.fadeUp}
      >
        <header>
